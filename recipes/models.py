...
class Recipe(models.Model):
    ...
    ingredients = models.ManyToManyField(Ingredient, through='Unit', through_fields=('recipe', 'ingredient'),
...
class Follow(models.Model):
    ...
    following = models.ForeignKey(User, on_delete=models.CASCADE, related_name='following', verbose_name='Автор')
...
class ShoppingList(models.Model):
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='author_shopping_list', verbose_name='Автор')
